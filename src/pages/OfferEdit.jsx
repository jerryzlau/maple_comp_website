...
export default function OfferEdit() {
  ...
  useEffect(() => {
    if (offer) {
      ...
      setFormData({
        candidate_full_name: offer.candidate_full_name || '',
        candidate_email: offer.candidate_email || '',
        position: offer.position || '',
        location: offer.location || '',
        annual_salary_cents: offer.annual_salary_cents ? offer.annual_salary_cents / 100 : '',
        equity_percent_bps: offer.equity_percent_bps || '',
        start_date: offer.start_date ? offer.start_date.split('T')[0] : '',
        expires_at: offer.expires_at ? offer.expires_at.split('T')[0] : '',
        manager_full_name: offer.manager_full_name || '',
        manager_position: offer.manager_position || '',
        recruiter_full_name: offer.recruiter_full_name || '',
        recruiter_email: offer.recruiter_email || '',
        vesting_schedule: offer.vesting_schedule || '',
        organization_name: offer.organization?.name || '',
        organization_valuation_cents: offer.organization?.valuation_cents ? offer.organization.valuation_cents / 100 : '',
        strike_price_cents: offer.organization?.strike_price_cents || '',
        shares_outstanding: offer.organization?.shares_outstanding || '',
      })
      
      // Populate equity packages
      if (offer.equity_packages && offer.equity_packages.length > 0) {
        setEquityPackages(offer.equity_packages.map(pkg => ({
          equity_units: pkg.equity_units.toString(),
      ...
      <div className="offer-manage">
        <div className="manage-header">
          <div className="header-content">
            ...
            <p>The offer you're trying to edit doesn't exist.</p>
          </div>
          <button 
  ...
  return (
    <div className="offer-manage">
      <div className="manage-header">
        <div className="header-content">
          <h1>✏️ Edit Offer</h1>
          <p>Update offer details for {offer.candidate_full_name}</p>
        </div>
        <button 
          className="btn-create-offer"
          onClick={() => navigate('/manage/offer')}
      ...
      <div className="offer-form-container fade-in">
        <div className="form-header">
          ...
          <p>Update the information below to modify this offer</p>
        </div>
